...
Metrics sent via telemetry (to Red Hat) are defined separately. See the [Sending metrics via Telemetry](https://rhobs-handbook.netlify.app/products/openshiftmonitoring/telemetry.md/) page and the [data collection documentation](data-collection.md).
